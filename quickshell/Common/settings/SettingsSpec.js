...
var SPEC = {
    ...
    batteryScreensaverTimeout: { def: 120 },
    ...
    screensaverType: { def: "text" },
    screensaverText: { def: "DankMaterialShell" },
    screensaverEffect: { def: "random" },
