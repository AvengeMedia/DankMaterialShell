...
func handleCast(conn *models.Conn, req models.Request, manager *Manager) {
...
func handleControl(conn *models.Conn, req models.Request, action func() error, okMsg string) {
...
func handleSeek(conn *models.Conn, req models.Request, manager *Manager) {
...
func handleSetVolume(conn *models.Conn, req models.Request, manager *Manager) {
...
func handleSetMuted(conn *models.Conn, req models.Request, manager *Manager) {
...
func handleCastScreen(conn *models.Conn, req models.Request, manager *Manager) {
...
func handleStopScreen(conn *models.Conn, req models.Request, manager *Manager) {
	manager.StopScreen()
	models.Respond(conn, req.ID, models.SuccessResult{Success: true, Message: "screen stopped"})
}

func handleSetPreferred(conn *models.Conn, req models.Request, manager *Manager) {
	id := models.GetOr(req, "id", "")
	if id == "" {
		models.RespondError(conn, req.ID, "missing device id")
		return
