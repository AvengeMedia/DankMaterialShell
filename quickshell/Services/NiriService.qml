...
`;
    ...
    function generateNiriInputConfig() {
        ...
        const defaultKeyboardLayouts = "us";
        const defaultKeyboardVariants = "";
        const defaultKeyboardModel = "";
        const defaultKeyboardOptions = "grp:win_space_toggle";
        const defaultKeyboardKeymapFile = "";
        const defaultKeyboardTrackLayout = "global";
        const defaultKeyboardRepeatDelay = 600;
        const defaultKeyboardRepeatRate = 25;
        const defaultKeyboardNumlock = false;

        const keyboardLayouts = typeof SettingsData !== "undefined" ? SettingsData.keyboardLayouts : defaultKeyboardLayouts;
        const keyboardVariants = typeof SettingsData !== "undefined" ? SettingsData.keyboardVariants : defaultKeyboardVariants;
        const keyboardModel = typeof SettingsData !== "undefined" ? SettingsData.keyboardModel : defaultKeyboardModel;
        const keyboardOptions = typeof SettingsData !== "undefined" ? SettingsData.keyboardOptions : defaultKeyboardOptions;
        const keyboardKeymapFile = typeof SettingsData !== "undefined" ? SettingsData.keyboardKeymapFile : defaultKeyboardKeymapFile;
        const keyboardTrackLayout = typeof SettingsData !== "undefined" ? SettingsData.keyboardTrackLayout : defaultKeyboardTrackLayout;
        const keyboardRepeatDelay = typeof SettingsData !== "undefined" ? SettingsData.keyboardRepeatDelay : defaultKeyboardRepeatDelay;
        const keyboardRepeatRate = typeof SettingsData !== "undefined" ? SettingsData.keyboardRepeatRate : defaultKeyboardRepeatRate;
        const keyboardNumlock = typeof SettingsData !== "undefined" ? SettingsData.keyboardNumlock : defaultKeyboardNumlock;
...
`;
        ...
        if (keyboardKeymapFile) {
            inputContent += "        xkb {\n";
            inputContent += `            file "${keyboardKeymapFile}"\n`;
            inputContent += "        }\n";
        } else {
            inputContent += "        xkb {\n";
            if (keyboardLayouts) {
                inputContent += `            layout "${keyboardLayouts}"\n`;
            }
            if (keyboardVariants) {
                inputContent += `            variant "${keyboardVariants}"\n`;
            }
            if (keyboardModel) {
                inputContent += `            model "${keyboardModel}"\n`;
            }
            if (keyboardOptions) {
                inputContent += `            options "${keyboardOptions}"\n`;
            }
            inputContent += "        }\n";
        }
        ...
        if (keyboardRepeatDelay > 0 && keyboardRepeatRate > 0) {
