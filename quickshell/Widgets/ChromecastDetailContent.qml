            ...
            Column {
                ...
                RowLayout {
                    ...
                    DankActionButton {
                        ...
                        iconSize: 20
                        iconColor: Theme.surfaceVariantText
                        tooltipText: muted ? I18n.tr("Unmute") : I18n.tr("Mute", "Mutes playback on the connected Cast device")
                    ...
                    delegate: Rectangle {
                        ...
                        RowLayout {
                            ...
                            DankActionButton {
                                ...
                                tooltipText: deviceCard.isActive ? I18n.tr("Disconnect") : I18n.tr("Cast to this device", "Connects to the selected Cast device")
                                Layout.alignment: Qt.AlignVCenter
                                onClicked: {
