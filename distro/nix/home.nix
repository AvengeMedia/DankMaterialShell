...
in
{
  imports = [
    ...
    (lib.mkRemovedOptionModule [
      ...
      "default"
      "settings"
    ] "Declared settings are now respected. Changes in the GUI will generate a gui_settings.json file.")
    (lib.mkRemovedOptionModule
      [
        "programs"
        "dank-material-shell"
      ...
      "Declared session settings are now respected. Changes in the GUI will generate a gui_session.json file."
    )
