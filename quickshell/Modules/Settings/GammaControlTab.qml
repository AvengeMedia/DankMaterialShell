    ...
    DankFlickable {
        ...
        Column {
            ...
            SettingsCard {
                ...
                title: I18n.tr("Gamma Control")
                settingKey: "gammaControl"
            ...
            SettingsCard {
                ...
                SettingsToggleRow {
                    ...
                    tags: ["gamma", "night", "mode", "fullscreen"]
                    text: I18n.tr("Fullscreen Applications")
                    description: I18n.tr("Disable night mode when using fullscreen applications.")
                ...
                Column {
                    ...
                    StyledText {
                        text: I18n.tr("Disable night mode when focusing on specific applications (media player, editor, game, ...)")
                        font.pixelSize: Theme.fontSizeSmall
                        color: Theme.surfaceVariantText
                        wrapMode: Text.Wrap
                        width: parent.width
                    ...
                    Row {
                        ...
                        DankTextField {
                            id: newNightModeExcludedAppField
                            width: parent.width - addBtn.width - selectAppBtn.width - Theme.spacingS * 2 - Theme.spacingM * 2
                            height: 36
                            ...
                            onAccepted: {
                                ...
                                if (cleanInput !== "") {
                                    SettingsData.addNightModeExcludedApp(cleanInput);
                                }
                                text = "";
                            }
                        }
                        ...
                        DankActionButton {
                            ...
                            onClicked: {
                                const cleanInput = newNightModeExcludedAppField.text.trim();
                                if (cleanInput !== "") {
                                    SettingsData.addNightModeExcludedApp(cleanInput);
                                }
                                newNightModeExcludedAppField.text = "";
                            }
                        }
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                Row {
                                    ...
                                    Row {
                                        width: parent.width - deleteBtn.width - Theme.spacingXS
                    ...
                    StyledText {
                        visible: !SettingsData.nightModeExcludedApps || SettingsData.nightModeExcludedApps.length === 0
                        text: I18n.tr("No excluded application configured")
                        font.pixelSize: Theme.fontSizeSmall
                        font.italic: true
                        color: Theme.surfaceVariantText
                        horizontalAlignment: Text.AlignHCenter
