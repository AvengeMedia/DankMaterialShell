    ...
    function setDesiredTheme(kind, value, isLight, iconTheme, matugenType, stockColors) {
        ...
        if (typeof SettingsData !== "undefined") {
            ...
            if (!SettingsData.runDmsMatugenTemplates) {
                skipTemplates.push("gtk", "nvim", "niri", "qt5ct", "qt6ct", "qtengine", "firefox", "pywalfox", "zenbrowser", "vesktop", "vencord", "equibop", "ghostty", "kitty", "foot", "alacritty", "wezterm", "dgop", "kcolorscheme", "vscode", "emacs", "zed");
            } else {
