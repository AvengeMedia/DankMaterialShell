...
const DMS_ACTIONS = [
    ...
    { id: "spawn dms ipc call screensaver toggle", label: "Screensaver: Toggle" },
    { id: "spawn dms ipc call screensaver open", label: "Screensaver: Open" },
    { id: "spawn dms ipc call screensaver close", label: "Screensaver: Close" },
