...
Rectangle {
    ...
    readonly property string hintsText: {
        if (!wtypeAvailable)
            return I18n.tr("Ctrl+Tab: Switch Tab • Shift+Del: Clear All • Esc: Close");
        return enterToPaste ? I18n.tr("Ctrl+Tab: Switch Tab • Shift+Enter: Copy • Shift+Del: Clear All • Esc: Close", "Keyboard hints when enter-to-paste is enabled") : I18n.tr("Ctrl+Tab: Switch Tab • Shift+Enter: Paste • Shift+Del: Clear All • Esc: Close");
    }
